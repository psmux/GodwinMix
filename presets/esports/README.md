...
**The encoder is behind.** 1080p60 with no GPU is more than a laptop can do. Drop the canvas to 30 fps, or run this on a box with a GPU. The Alerts panel says when the encoder is falling behind.
