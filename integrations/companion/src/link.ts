// The connection to the mixer, with no Companion in it.
//
// Everything this module does to a mixer happens here, and nothing here knows
// what a Companion instance is. That is what makes the behaviour testable
// against the fake core in `test/fake-core.ts` without installing Companion's
// module base, which is a package this repository cannot fetch.
//
...
export interface LinkOptions {
  ...
  base: string;
  token?: string | null;
  /** Node 20 has no global WebSocket. Companion 3 runs on 18 or newer. */
