 ...
 * `plugin.list` covers the rest. `builtIn` is the table for `what`: the
 * source kinds unless the caller hands over the output ones.
 */
export async function loadKinds(client, what, plugins, builtIn = SOURCE_KINDS) {
